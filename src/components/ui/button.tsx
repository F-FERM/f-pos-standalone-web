...
login: `mt-4 sm:mt-6 mb-2 flex h-[42px] sm:h-[46px] md:h-[50px] w-full max-w-[365px]
  items-center justify-center gap-2.5 rounded-[10px] bg-[#3EA200]
  py-[9px] sm:py-[10px] md:py-[11px]
  px-8 sm:px-10 md:px-[52px]
  cursor-pointer font-poppins text-sm sm:text-[15px] md:text-base font-bold
  tracking-wide text-white hover:bg-[#22C55E]/90 disabled:opacity-60`,
          destructive:
